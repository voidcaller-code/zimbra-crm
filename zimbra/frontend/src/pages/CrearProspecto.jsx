...
const CrearProspecto = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setExito('Prospecto creado correctamente.');
      ...
      if (data) {
        ...
        setError(firstMessage || 'No se pudo crear el prospecto.');
      } else {
      ...
      <div style={cardStyle}>
        <div style={headerStyle}>
          <div>
            ...
            <h1 style={titleStyle}>Crear prospecto</h1>
            <p style={descriptionStyle}>
              Registra un nuevo prospecto interesado en Zimbra.
            </p>
          </div>
        ...
        <form onSubmit={handleSubmit} style={formStyle}>
          ...
          <div style={actionsStyle}>
            ...
            <button type="submit" style={primaryButtonStyle} disabled={cargando}>
